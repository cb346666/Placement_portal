<?php 
	...
	$row = db_query("select * from user where id = :id limit 1",['id'=>$id]);
            ...
            <form method="post" onsubmit="myaction.collect_data(event, 'profile-edit')">
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td>
                            <input value="<?=$row['firstname']?>" type="text" class="form-control" name="firstname"
                    ...
                    <tr>
                        ...
                        <td>
                            <input value="<?=$row['lastname']?>" type="text" class="form-control" name="lastname"
