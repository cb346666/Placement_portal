    ...
    <div class="main">
        <div class="navbar-side">
            ...
            <ul>
                ...
                <li>
                    <a href="../track_application/dashboard.html" class="myBtn" data-target="post_job_news" title="Post"
                        aria-expanded="false">
            ...
            <a href="#" title="Add Post">
              ...
              <span class="link-text">Add Post</span>
                ...
                <li><a href="../messaging/user.php" title="Comment">
              ...
              <span class="link-text">Tags</span>
                ...
                <li><a href="../profile/index.html" title="Profile">
