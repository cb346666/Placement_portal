                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <a class="dropdown-item"
                                    href="./components/student_authentication/std_authentication.php">Student
                                    Login</a>
                                <a class="dropdown-item"
                                    href="./components/admin_authentication/admin_authentication.php">Faculty
                                    Login</a>
            ...
            <div class="row">
                <div class="col-md-7 col-sm-12">
                    ...
                    <p>Explore job opportunities and connect with
                        employers.</p>
                    <a href="./components/student_authentication/std_authentication.php" class="btn"><button>
...
$sql = "SELECT * FROM job_news ORDER BY created_at DESC LIMIT 1";
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $file_path = "./components/post_job_news/uploads/" . $row['file_upload']; // Assuming 'file_upload' contains the file path
...
?>
    ...
    $(window).scroll(function() {
        ...
        // If the user is scrolling down and is past the navbar, hide it
        if (currentScrollTop > lastScrollTop && currentScrollTop > navbar.height()) {
            navbar.removeClass("show-navbar").addClass("hide-navbar");
        } else {
            // If the user is scrolling up or is at the top of the page, show the navbar
