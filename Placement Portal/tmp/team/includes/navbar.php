...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="admin_profile.php">Admin Profile</a>
                <a class="collapse-item" href="student_profile.php">Student Profile</a>
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="./interested_user.php" data-target="#collapseUtilities" aria-expanded="true"
    ...
    <li class="nav-item">
        <a class="nav-link" href="./msg/index.php">
